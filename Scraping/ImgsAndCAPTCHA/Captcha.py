...
imageLocation = bsObj.find("img", {"title": "Image CAPTHA"})["src"]
...
p = subprocess.Popen(["tesseract", "captcha.jpg", "captcha"], stdout=subprocess.PIPE,
                     stderr=subprocess.PIPE)
p.wait()
f = open("capthca.txt", "r")
...
if len(captchaResponse) == 5:
    params = {"captcha_toke": captchaToken, "captcha_sid": captchaSid,
              "from_id": "comment_node_page_form", "form_build_id": formBuildId,
